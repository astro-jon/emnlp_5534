    ...
    for para in para_dict:
        for fold in range(5):
            test_data = pd.read_csv(
                f'path/to/emnlp_bigbird_option_pos_middle_{cloze}_{distractor}_{control_label}/fold_{fold}/test_final.csv'
            )
            ...
            save_path = f'../data_emnlp_final/model_answer_middle_emnlp_{cloze}_{distractor}/{control_label}/'
